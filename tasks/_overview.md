...
| Task | File | Branch | Status | Depends On |
|------|------|--------|--------|------------|
| Layout shell + routing | `P3-01_layout-shell.md` | `feature/layout-shell` | [ ] | P2-04 |
| Sidebar + phase groups | `P3-02_sidebar.md` | `feature/sidebar` | [ ] | P3-01 |
| Detail panel + Content tab | `P3-03_detail-panel.md` | `feature/detail-panel` | [ ] | P3-01 |
